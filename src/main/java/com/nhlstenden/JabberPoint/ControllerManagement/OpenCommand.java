        ...
        if (returnValue == JFileChooser.APPROVE_OPTION) {
            try {
                ...
                if (!file.getName().endsWith(".xml")) {
                    JOptionPane.showMessageDialog(parentFrame, "Error opening file: " + "Invalid file type", "Open Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                JOptionPane.showMessageDialog(parentFrame, "Error opening file: " + exc.getMessage(), "Open Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
